...
import 'package:flutter/services.dart'; // <-- BARU: Untuk mengatur warna tulisan status bar OS
...
class _TechnicianDashboardState extends State<TechnicianDashboard> {
  ...
  bool _isLoggingOut = false; // <-- BARU: State guard untuk mencegah spam klik / race condition

  // --- FUNGSI ASLI: Dipertahankan logika dasarnya dengan proteksi State ---
  Future<void> _logout() async {
    if (_isLoggingOut) return; // Cegah eksekusi ganda jika sedang proses
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _isLoggingOut = false; // Reset jika gagal agar user bisa mencoba lagi
        });
  ...
  Widget build(BuildContext context) {
    // BARU: AnnotatedRegion memastikan jam & ikon sinyal di atas layar otomatis berwarna PUTIH (kontras dengan gradien biru)
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      // BARU: PopScope mengunci navigasi gesture/tombol back fisik bawaan HP agar tidak langsung keluar app secara tidak aman
      child: PopScope(
        canPop: false,
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          // Di sini bisa ditambahkan dialog konfirmasi jika diperlukan di masa depan
        },
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // ================= HEADER BANNER GRADIEN BIRU ROYAL =================
                Container(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          // Tombol Logout Sesuai Tema dengan Loading State Guard
                          Container(
                            decoration: BoxDecoration(
                              color: Colors.white.withOpacity(0.15),
